<template>
  <div>
    ...
    <b-list-group class="filter__1__country">
      ...
      <b-list-group-item href="#fr">France</b-list-group-item>
      <b-list-group-item href="#es">Espagne</b-list-group-item>
      <b-list-group-item href="#ch">Suisse</b-list-group-item>
      <b-list-group-item href="#wr">Autres Pays</b-list-group-item>
    </b-list-group>
    <hr></hr>
...
<script src="./FilterProducts_1.js"></script>
<style src="./FilterProducts_1.css" scoped></style>
